...
class Continent(models.Model):
    ...
    def clean_population(self):
        ...
        aggregated_population = aelf.country_set.all().aggregate(models.Sum('population'))
        print(aggregated_population)

        if passed_population > aggregated_population:
            raise ValidationError('The passed population is greater than the sum of the popluaitons of all the counties in the continent')
